    ...
    public function rules(): array
    {
        ...
        foreach ($languages as $lang) {
            ...
            if ($code === $defaultCode) {
                ...
                $rules["translations.{$code}.slug"] = 'required|string|max:255|unique:project_category_translations,slug';
            } else {
                $rules["translations.{$code}.name"] = 'nullable|string|max:255';
                $rules["translations.{$code}.slug"] = 'nullable|string|max:255|unique:project_category_translations,slug';
            }
        }
