            ...
            <div class="row align-items-center">
                <div class="col-md-9">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Certification Management</h5>
                    </div>
                    <ul class="breadcrumb">
    ...
    <div class="card">
        <div class="card-body">
            <div class="section-hint mb-3"
                ...
                Ditampilkan di: <strong style="color:#333;">About Page → Certifications Section</strong> (4 cards)
            </div>
            <div class="table-responsive">
                <table id="certifications-table" class="table table-hover mb-0" style="width:100%">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
                            <th>Name</th>
...
@push('scripts')
    @include('backend.certifications._script')
@endpush