...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.project-categories.index') }}">Categories</a>
                        </li>
    ...
    <form action="{{ route('admin.project-categories.update', $category->id_project_category) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
