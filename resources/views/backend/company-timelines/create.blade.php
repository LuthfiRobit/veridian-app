...
@section('title', 'Add Timeline Milestone')
...
@section('content')
    <div class="page-header mb-3">
        <div class="page-block">
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title"><h5 class="m-b-10">Add Timeline Milestone</h5></div>
                    <ul class="breadcrumb">
    ...
    <form action="{{ route('admin.company-timelines.store') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-{{ $language->code }}" role="tabpanel">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('translations.' . $language->code . '.title') is-invalid @enderror"
                                            ...
                                            placeholder="e.g. Company Founded" @if($loop->first) required @endif>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('translations.' . $language->code . '.description') is-invalid @enderror"
                                            ...
                                            rows="4" placeholder="Describe this milestone...">{{ old('translations.' . $language->code . '.description') }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('year') is-invalid @enderror"
                                name="year" value="{{ old('year') }}" placeholder="e.g. 2009" required>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            new TomSelect("#icon_class", {
                maxOptions: null,
                options: iconOptions,
                items: {!! json_encode([old('icon_class', 'bi bi-flag')]) !!},
                create: true,
