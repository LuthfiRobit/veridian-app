...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Edit Core Value</h5>
                    </div>
                    <ul class="breadcrumb">
    ...
    <form action="{{ route('admin.core-values.update', $coreValue->id_core_value) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            @foreach($sortedLanguages as $language)
                                @php $t = $coreValue->translate($language->code); @endphp
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="sort_order"
                                value="{{ old('sort_order', $coreValue->sort_order) }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Status</label>
                            <select class="form-select" name="is_active">
                                <option value="1" {{ old('is_active', $coreValue->is_active ? '1' : '0') == '1' ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('is_active', $coreValue->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            new TomSelect("#icon_class", {
                maxOptions: null,
                options: iconOptions,
                items: {!! json_encode([old('icon_class', $coreValue->icon_class)]) !!},
                create: true,
